...
class HumanPlayer(Player):
    ...
    def get_move(self, game):
        ...
        while not valid_square:
            ...
            # we're going to check that this is a current value by trying to cast
...
# No 7. Unbeatable computer using minimax algorithm
class GeniusComputerPlayer(Player):
    ...
    def get_move(self, game):
        if len(game.available_moves()) == 9:
            ...
            # get the square based off the maximax algorithm

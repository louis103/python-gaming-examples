...
class Board:
    def __init__(self, dim_size, num_bombs):
        # let's keep a track of these parameters. They'll be helpful later
        ...
        # initialized a set to keep track of which locations we've uncovered
    ...
    def get_num_neighboring_bombs(self, row, col):
        # let's iterate through each of the neighboring positions and number of bombs
    ...
    def __str__(self):
        ...
        # put this entire board together in a string
        string_rep = ''
